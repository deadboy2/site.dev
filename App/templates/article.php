    ...
    <div class="row">
        <div class="col-xs-12 col-sm-9 col-md-8 col-lg-9">
            <div class="panel panel-default">
                ...
                <div class="panel-body text-news"><?= $article->text ?></div>
                <div class="panel-body name-news"><?= $article->author->name ?></div>
                <div class="panel-footer"><a href="http://site.dev/articles">Назад<<<</a></div>
            </div>
        </div>
